# Django settings for groupjam project.
import os
...
if PRODUCTION:
    ...
    # CDN
    AWS_STORAGE_BUCKET_NAME = 'groupjam'
    S3_URL = 'http://groupjam.s3.amazonaws.com/'
    ...
    DATABASES = {
        'default': {
            ...
            'NAME': 'groupjam.db',                      # Or path to database file if using sqlite3.
    ...
    # CDN
    AWS_STORAGE_BUCKET_NAME = 'groupjamdev'
    S3_URL = 'http://groupjamdev.s3.amazonaws.com/'
...
ROOT_URLCONF = 'groupjam.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'groupjam.wsgi.application'
