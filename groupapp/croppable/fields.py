...
from groupapp.croppable.settings import IMAGE_FIELD_DELIMITER
from groupapp.croppable.widgets import CroppableImageWidget
...
add_introspection_rules(rules, ['^groupapp\.croppable\.fields\.CroppableImageField'])
